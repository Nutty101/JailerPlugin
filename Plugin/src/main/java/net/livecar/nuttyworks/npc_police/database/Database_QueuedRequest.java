...
public class Database_QueuedRequest {
    ...
    public enum RequestType {
        LOAD_USER, SAVE_USER, REMOVE_USER, LEADERHEADS_BOUNTIES, LEADERHEADS_LASTARRESTS, LEADERHEADS_LASTESCAPES, LEADERHEADS_MOSTARRESTS, LEADERHEADS_MOSTMURDERS, LEADERHEADS_MOSTESCAPES, LEADERHEADS_TOTALBOUNTIES
    }
}
