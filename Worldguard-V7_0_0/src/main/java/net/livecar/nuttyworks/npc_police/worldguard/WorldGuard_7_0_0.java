...
public class WorldGuard_7_0_0 extends VersionBridge implements Listener {
    ...
    public void registerHandlers() {
        new BukkitRunnable() {
            @Override
            public void run() {
                WorldGuard.getInstance().getPlatform().getSessionManager().registerHandler(WorldGuard_7_0_0_RegionalHandler.FACTORY, null);
            }
