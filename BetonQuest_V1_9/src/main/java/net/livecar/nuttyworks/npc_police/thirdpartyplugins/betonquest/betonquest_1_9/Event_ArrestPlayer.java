...
public class Event_ArrestPlayer extends QuestEvent {
    public Event_ArrestPlayer(Instruction instruction) throws InstructionParseException {
        super(instruction);
    }
