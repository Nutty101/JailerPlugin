...
public class Event_ClearWanted extends QuestEvent {
    public Event_ClearWanted(Instruction instruction) throws InstructionParseException {
        super(instruction);
    }
