...
public class Event_ClearLockedInventory extends QuestEvent {
    public Event_ClearLockedInventory(Instruction instruction) throws InstructionParseException {
        super(instruction);
    }
    ...
    public void run(String playerID) {
        ...
        plrManager.clearLockedInventory();
    }
}
